...
If the assumptions of the censored regression model are inappropriate then two-part models may be considered to separate modelling of detection and concentration.

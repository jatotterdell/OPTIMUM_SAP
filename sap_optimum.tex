...
\begin{enumerate}[resume]
	...
	seroprotective IgG titres for tetanus toxoid at $\geq0.1$ IU/mL \cite{whotetanus}, Hib-PRP at $\geq$1.0 $\mu$g/mL \cite{kayhty1983protective}
	and for all 13-valent pneumococcal vaccine serotypes at $\geq 0.35$ $\mu$g/mL \cite{siber2007estimating,whopneumo}.
\end{enumerate}
...
Sensitivity analyses will investigate additional model complexity allowing for serial correlation and heterogeneity of variances by visit schedule by specifying an unstructured covariance.
If issues arise with this covariance structure, a simpler covariance model will be assumed, such as heterogenous compound symmetry.
...
Sensitivity of results to the specified priors will be investigated by estimating parameters under different 
prior configurations than those used in the primary analyses.
In particular, the hyperparameter for prior variances will be varied to assess 
how conclusions may change under varying strength of the prior.

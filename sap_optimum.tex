...
\begin{enumerate}[resume]
	...
	\end{itemize}
	For each antigen, we will assess the ratio of the geometric mean concentration (GMC) of antidoes across groups at each time point, the fold-rise in concentration from 18 to 19 months, and seroprotection/seropositivity.
...
\begin{itemize}
	...
	\item $\geq$2 first degree relatives with clinician-confirmed asthma, allergic rhinitis, atopic dermatitis, or IgE-mediated allergy
...
\begin{table}[!ht]
	...
	\begin{tabular}{lp{8cm}}
		...
		\\
		Stage 1 assays (PP) & All participants in the per-protocol set who were enrolled under stage 1 protocol at the Perth Children's Hospital (PCH)/Telethon Kids Institute site and who met none of the stage 1 elimination criteria and who did not receive any contraindicated vaccines or medications for stage 1.\\
...
Non-inferiority of the wP vaccine strategy compared to the standard aP vaccine strategy with respect to PT will be assessed against a non-inferiority margin of 2/3 on the GMC ratio.

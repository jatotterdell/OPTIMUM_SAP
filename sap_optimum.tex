...
The purpose of this double-blind, randomised, controlled trial is to compare allergic outcomes in children following vaccination with acellular pertussis (aP) antigen given at 2 months of age versus whole cell pertussis (wP) in the infant vaccine schedule.
...
\parttitle{Study protocol} REFER TO PUBLISHED PROTOCOL HERE
...
\begin{enumerate}
	\item Clinical - compare the rate of new onset atopic dermatitis in each study group. 
	...
	\end{enumerate}
	\item Mechanical - compare the rate of SPT positivity to common allergens in each study group.
	Two binary outcomes will be investigated:
	\begin{enumerate}
...
\subsubsection*{Stage 1 and 2 outcomes}

	\item (Stage 1 only) Atopic immunophenotype - compare the Th2 immunophenotypic response to tetanus toxoid and egg	antigens in infants in each	study group.
	IgE concentrations to the following antigens will be collected at...
	\begin{enumerate}
	...
	\end{enumerate}
	\item Determine if vaccine responses differ in each study group.
	\begin{enumerate}

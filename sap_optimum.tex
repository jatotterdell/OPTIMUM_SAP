...
Operating characteristics of trial decision rules were evaulated by trial simulation.
The selected decision rules for trial success and futility approximately maintained type I error of 5\% and achieved power 0.85 
for a reduction in the primary outcome from 10\% in the control group to 7\% in the intervention group.

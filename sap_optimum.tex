...
Figures \ref{fig:superiority_16} and \ref{fig:expected_ss_16} present power for superiority and expected sample size respectively over the grid of effect sizes and decision thresholds.
...
Table \ref{tab:oc1} summarises the operating characteristics assuming thresholds $q=0.95$, $\underline{c}=0.05$, and $\overline{c}=0.95$.
Assuming constant accrual of 16 participants per week, false positives occurred with approximate probability 0.05.

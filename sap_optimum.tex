...
For inferences, the mean concentrations (and 95\% CrI) will be estimated using censored linear mixed models assuming that concentrations are log-normally distributed with a fixed treatment effect, fixed effects for visit, interactions between visit and treatment, and participant specific effects. Sensitivity analyses will investigate serial correlation and heterogeneity of variances by visit schedule.
